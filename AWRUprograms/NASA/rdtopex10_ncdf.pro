pro rdtopex10_ncdf, filename, woce_date, julian_day_1990, latitude, longitude, sea_level
 
; IDL routine to read TOPEX 1.0 degree grids in WOCE SAT CD-ROMs.
;
; INPUT
...
;   sea_level:  (intarr(360,180)), in millimeters
;
; K. Case 20000615
...
; Test program for rdtopex. Check output against 'rdtopex10.out'
 
filename='../data/10_deg/ssh10d19921004.nc'
rdtopex10_ncdf, filename, woce_date, julian_day_1990, latitude, longitude, sea_level
...
for j=j1-1, j2-1 do begin
  for i=i1-1, i2-1 do begin
    print, woce_date, julian_day_1990, latitude(j), longitude(i), sea_level(i,j)
  endfor
endfor
