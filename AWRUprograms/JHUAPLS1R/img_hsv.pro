...
;-------------------------------------------------------------
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  print,'   tv,img_hsv(img,hue=0,sat=1.5,val=1.5),tr=3'
	  return, ''
	endif
	...
	if ndim ne 3 then begin
	  err = 1
	  print,' Error in img_hsv: given array 3-D only.'
	  return, img
	endif
	...
	if typ eq 0 then begin
	  err = 2
	  print,' Error in img_hsv: given array must have a dimension of 3.'
	  return, img
	endif
