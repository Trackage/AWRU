...
flags:	w = where(strupcase(strmid(txt0,0,4)) eq 'FLAG',cnt) ; Any flag lines?
	if cnt eq 0 then begin          ; No.
...
;==============================================================
	...
	pro eqv3, file, top=top, ok=ok, res=res, help=hlp, wait=wait, $
	  ...
	  exitcode=excode, xoffset=xoff, yoffset=yoff, $
	  p1=p10, p2=p20, p3=p30, p4=p40, p5=p50
...
help:	  print,' Execute IDL code using interactively varied parameters.'
	  ...
	  print,' '
	  print,' Notes:  Use the Help button for more details.'
	  ...
	  print,'    eqv: x=maken(-10,10,100) & plot,a + b*x + c*x^2'
	  print,'    par:  a -50 50 0'
	  print,'    par:  b -50 50 0'
	  print,'    par:  c -10 10 1'
	  print,' '
