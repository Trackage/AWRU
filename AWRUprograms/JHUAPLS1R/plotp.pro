...
;-------------------------------------------------------------
	...
	pro plotp, x, y, p, help=hlp, data=dt, device=dv, normalized=nm, $
	  color=clr, linestyle=linestyle, thick=thk, clip=clip
	...
	for i = 0L, nw0-2 do begin
	  ...
	  if keyword_set(clip) then begin
	    oplot, xx, yy, color=clr, linestyle=linestyle, thick=thk
	  endif else begin
	    case flg of			; Use correct coordinate system.
1:	      plots, xx, yy, /data, color=clr, linestyle=linestyle, thick=thk
2:	      plots, xx, yy, /device, color=clr, linestyle=linestyle, thick=thk
3:	      plots, xx, yy, /normal, color=clr, linestyle=linestyle, thick=thk
	    endcase
	  endelse
	endfor
