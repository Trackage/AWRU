...
4:	begin						; 4 Pages.
	  sz=size(a) & nx=sz(1) & ix=nx/2 & ny=sz(2) & iy=ny/2
	  prwindow2,pnum,a(0:ix-1,0:iy-1),r,g,b,comment=cmt,fact=fct,charsiz=csz
	  prwindow2,pnum,a(ix:*,  0:iy-1),r,g,b,comment=cmt,fact=fct,charsiz=csz
	  prwindow2,pnum,a(0:ix-1,  iy:*),r,g,b,comment=cmt,fact=fct,charsiz=csz
	  prwindow2,pnum,a(ix:*,    iy:*),r,g,b,comment=cmt,fact=fct,charsiz=csz
	end
	endcase
