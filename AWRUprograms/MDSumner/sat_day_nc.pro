;==============================================================================
FUNCTION SAT_DAY_NC, FILES, JDAY0, JDAY1, YEARS = YEARS, WEIGHTS = WEIGHTS
;==============================================================================
; NAME:   SAT_DAY
;
...
for n = 0, n_elements(files) - 1 do begin
	...
	;		help, yr_chk
	;		print, yr_chk
			IF yr_chk(0) NE -1 OR yr_chk2 NE - 1 THEN yr_ok = 1 ELSE yr_ok = -1   ;assign check flag
		ENDIF
	;	help, yr_ok
	...
	help, cover
		...
		IF n_elements(good) EQ  1 THEN weights = cover ELSE weights = [weights, cover]
