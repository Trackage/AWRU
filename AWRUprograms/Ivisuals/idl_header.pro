;--------------------------------------------------------------------------
 ...
 ; $RCSfile: idl_header.pro,v $
 ; $Revision: 1.2 $
 ; Orig: 1998/09/08
 ; $Date: 1999/05/24 15:36:46 $
 ;--------------------------------------------------------------------------
 ; Purpose: Generate IDL source control header files.
 ; History:
 ;--------------------------------------------------------------------------
 ; $Log: idl_header.pro,v $
 ; Revision 1.2  1999/05/24 15:36:46  mgs
 ; Changed output strings to prevent keyword expansion from occurring within file.
 ;
 ; Revision 1.1  1999/04/05 06:15:13  mgs
 ; First Checked In.
 ;
 ;--------------------------------------------------------------------------
     ...
     ENDIF ELSE BEGIN
         ...
         CASE sType OF
             ...
             'SCCS': BEGIN
                 ...
                 ;   output the date placeholder
                 PrintF, iLun, sComment + ' Delta Date: %' + 'G' + '% ' + $
                     '%' + 'U' + '%'
